...
export default function getWthrConditions(data) {
  ...
  const highWindThreshold = 15; 
  const lowWindThreshold = 5; 
  const highRainThreshold = 50; 
  ...
  const avgTemp = data.avgtemp_f;
    ...
    return new wthrConditions(
      ...
      highHumidity || (avgHumidity > lowHumidityThreshold && avgHumidity < highHumidityThreshold),
      lowHumidity || (avgHumidity > lowHumidityThreshold && avgHumidity < highHumidityThreshold)
    );
}
