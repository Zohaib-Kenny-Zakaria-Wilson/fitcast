    ...
    <div className="relative flex-grow" onBlur={handleBlur}>
      <div className="flex items-center justify-end w-full h-full transition-all duration-500">
        <input
          ...
          onFocus={handleFocus}
          className={`h-8 md:h-9lg:h-10 xl:h-11 2xl:h-12 text-xs md:text-sm xl:text-base px-4 transition-all duration-300 hover:dark:bg-dark-foreground hover:bg-foreground outline-none rounded-sm ${
        ...
        <div className="absolute flex items-center h-full pointer-events-none right-3">
          <svg
            className="size-4 lg:size-5 2xl:size-6 text-primary-tw dark:text-dark-primary-tw"
