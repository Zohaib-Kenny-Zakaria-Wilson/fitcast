...
export default function WeatherKeyInfo({ svg, text }) {
  return (
    <div className="w-full px-1 py-2 xl:px-2 xl:py-3 2xl:px-4 2xl:py-4 flex justify-center gap-2 rounded-lg bg-background dark:bg-dark-background text-primary-tw dark:text-dark-primary-tw">
      <img
